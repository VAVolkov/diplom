...
import cup from '../subscriptionHealthFood/images/cup.png';

import styles from './subscriptionHealthFoodStyle.module.scss';

export default function SubscriptionHealthFood() {
